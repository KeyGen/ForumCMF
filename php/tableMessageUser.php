...
$(function() {
    $( '#buttonPrivateLetter' ).button().click(function(){
        ...
        if(nameSession)
        window.location.href = 'privateoffice.php?user=$nameSession&&mail=$name';
        else
        ...
        <td>
            <fieldset>
                ...
                <button id='buttonPrivateLetter' style='height: 30px; width: 100%; font-size: 14px; text-align: center;'
                            onclick=\";\"><img style='height: 25px; position: absolute; left: 15px; top: -1px;' src='css/images/folderEmail.png'/>Отправить личное сообщение пользователю $name</button>
            </fieldset>
        </td>
    </tr>
</table>
